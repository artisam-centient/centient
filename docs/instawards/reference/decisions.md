...
| §3.1: **"anyone with a phone and a Stellar wallet"** | A phone signs in with the **Freighter Mobile app over WalletConnect v2** (#134, #135, #140, #142). A desktop uses the Freighter browser extension, or scans a QR code with the app. Still Freighter only | ADR-0003 left phones out; the D-4 ruling (22 Sep) brought them into Deliverable 3 | When #137's acceptance criteria pass on a real iOS and Android device inside the Epic 3 QA gate (#41) |
